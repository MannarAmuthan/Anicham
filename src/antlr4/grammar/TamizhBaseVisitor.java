...
public class TamizhBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements TamizhVisitor<T> {
	 ...
	 */
	@Override public T visitTamizh_script(TamizhParser.Tamizh_scriptContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitPatthi(TamizhParser.PatthiContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
